...
public class RepairOrderRegistryTest {
    ...
    public void testServerDownSituation(){
        assertThrows(DatabaseCanNotBeCalledException.class, ()->repairOrderRegistry.findRepairOrder(-1), "The server not found exception was not thrown.");
    }
}
