...
public class RepairOrderLogger implements RepairOrderObserver {
    ...
    public void repairOrderWasUpdated(RepairOrderDTO oldOrder, RepairOrderDTO updatedOrder) {
        ...
        updateLog.append(oldOrder.getProblemDesc() + "->" + updatedOrder.getProblemDesc() + ", ");
        updateLog.append(oldOrder.getPhoneNumber() + "->" + updatedOrder.getPhoneNumber() + ", ");
        updateLog.append(oldOrder.getBikeSerialNo() + "->" + updatedOrder.getBikeSerialNo() + ", ");
        updateLog.append(oldOrder.getDiagnosticResult() + "->" + updatedOrder.getDiagnosticResult() + ", ");
        updateLog.append(oldOrder.getRepairTask() + "->" + updatedOrder.getRepairTask() + ", ");
        updateLog.append(oldOrder.getState() + "->" + updatedOrder.getState() + ", ");
        updateLog.append(oldOrder.getTotalCost() + "->" + updatedOrder.getTotalCost() + ", ");
